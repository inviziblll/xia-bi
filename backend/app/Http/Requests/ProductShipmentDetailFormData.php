...
class ProductShipmentDetailFormData extends FormRequest
{
    /**
    ...
    {
        $rules = [
            'product_shipment_header_id' => 'required|integer',
    ...
    {
        return [
            'product_shipment_header_id.required' => 'Поле "идентификатор product shipment header" пустое или информация в нем не корректна',
